/**
 * Cromer–Mann atomic scattering factor coefficients (4-Gaussian form, no constant term).
 *
 * Source: International Tables for Crystallography Vol. C; compiled into a
 * machine-readable form by pymatgen (BSD-3-Clause, pymatgen.analysis.diffraction).
 * The numerical values themselves are scientific facts and not copyrightable;
 * we reproduce them here for convenience.
 *
 * Format: per element, four [a_i, b_i] pairs. f(s) = Σ a_i · exp(-b_i · s²)
...
export const ATOMIC_SCATTERING_PARAMS: ScatteringParams = {
